...
//            Microsoft.Office.Interop.Excel.Workbook wb = app.Workbooks.Add(Type.Missing);
      ...
      //          proc.StartInfo.WindowStyle = ProcessWindowStyle.Hidden;  //this is for hiding the cmd window...so execution will happen in back ground.
                ...
                bmp = new Bitmap(@"" + Constant.currentPath + "\\vunganh.jpg");
        ...
        private void ExecuteBatFile2()
        {
            ...
            try
            {
                ...
                proc = new Process();
                proc.StartInfo.WorkingDirectory = targetDir;
                proc.StartInfo.FileName = "tach_VungDiem.bat";
                proc.StartInfo.Arguments = @"" + Constant.pathImage + "";
                proc.StartInfo.CreateNoWindow = false;
                //  proc.StartInfo.WindowStyle = ProcessWindowStyle.Hidden;  //this is for hiding the cmd window...so execution will happen in back ground.
                proc.Start();
                ...
                //bmp = new Bitmap(@"" + Constant.currentPath + "\\bangdiem_reshape.png");
                //pictureBox2.Image = bmp;
                FileStream fileStream = new FileStream(@"" + Constant.currentPath + "\\imgAfterProcessing.jpg", FileMode.Open, FileAccess.Read);
