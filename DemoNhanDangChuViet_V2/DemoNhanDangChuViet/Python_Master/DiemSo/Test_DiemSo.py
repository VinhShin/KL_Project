...
def getDiemSo(im):
    ...
    for rect in rectangles:
        ...
        cv2.imwrite("test.png",region_of_interest)
        #conver lai 3l de nhan dien
        region_of_interest = cv2.cvtColor(region_of_interest, cv2.COLOR_GRAY2RGB)
        cv2.imshow("aa",region_of_interest)
        cv2.waitKey(0)
    ...
    #    return getDiemSo(im)
    return diemso
print getDiemSo(cv2.imread("2b.png"))
