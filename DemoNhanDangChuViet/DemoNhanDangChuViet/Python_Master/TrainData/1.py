...
def run(index):
    ...
    image = cv2.imread("./bangdiem/bangdiem"+str(index)+".png")
    imageOrigan = cv2.imread("./bangdiem/bangdiem"+str(index)+".png")
    ...
    cv2.imwrite("bangdiem_reshape"+str(index)+".png",warped);
    '''
    cv2.imshow("test",image)
    cv2.waitKey(0)
